...
export const quotes = sqliteTable("quotes", {
  ...
  depositInvoiceNumber: text("deposit_invoice_number").notNull().default(""),
  depositInvoiceSentAt: text("deposit_invoice_sent_at"),
  balanceInvoiceNumber: text("balance_invoice_number").notNull().default(""),
  balanceInvoiceSentAt: text("balance_invoice_sent_at"),
  orderConfirmationSentAt: text("order_confirmation_sent_at"),
